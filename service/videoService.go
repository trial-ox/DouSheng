...
type VideoService interface {
	...
	Feed(lastTime time.Time, userId int64) ([]common.Video, time.Time, error)

	// GetVideo
	// 传入视频id获得对应的视频对象
	GetVideo(videoId int64, userId int64) (common.Video, error)
	...
	List(userId int64, curId int64) ([]common.Video, error)
